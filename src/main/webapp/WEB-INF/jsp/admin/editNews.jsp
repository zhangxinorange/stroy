                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">修改新闻</div>
                            </div>
                            <div class="block-content collapse in">
                                <div class="span12">
                                     <form class="form-horizontal" action="${ctx }/news/updateNews" method="post">
                                      <fieldset>
                                        <legend>新闻管理</legend>
                                        <div class="control-group">
                                          <label class="control-label" for="focusedInput">新闻标题</label>
                                          <div class="controls">
                                            <input class="input-xlarge focused" id="nTitle" name="nTitle" type="text" value="${news.nTitle }">
                                         ...
                                         <div class="control-group">
                                          ...
                                          <div class="controls">
                                            <!-- <input class="input-xlarge focused" id="nName" name="nName" type="text" > -->
                                           	<textarea id="nContent" name="nContent" rows="6" cols="200" style="width: 50rem;">${news.nContent }</textarea>
                                          </div>
                                        </div>
