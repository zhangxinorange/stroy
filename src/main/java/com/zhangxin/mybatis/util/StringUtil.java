...
public class StringUtil {
	...
	/**
	 * 将原字符串按指定分隔符分隔成Integer数组
	 * @param str 原字符串
	 * @param split 分隔符
	 * @return
	 */
	public static Integer[] StringtoInteger(String str,String split) {  
	...
	public static String[] getStrBySplit(String value,String sp)
	{
		String[] str=null;
		if (!isEmpty(value)) {
			if (value.endsWith(sp)) {
				value=value.substring(0, value.length()-sp.length());
			}
			str=value.split(sp);
		}
		return str;
